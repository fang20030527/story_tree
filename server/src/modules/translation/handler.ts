...
import type { AiProvider, ModerationResult } from '../../infrastructure/ai/types';
...
export async function handleTranslation(
  ...
  assertModerationAccepted(moderation);
...
function assertModerationAccepted(result: ModerationResult): void {
