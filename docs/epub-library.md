...
仓库快照提供 15 份《经济学人》逐篇音频清单，覆盖 2025-01-04 至 2025-04-12。全部 910 条已按刊物、期号和完整标题唯一匹配，进入文章概述或阅读页即可使用现有播放器播放、暂停和拖动进度。音频从清单中的出版方 HTTPS 地址在线加载，不增加安装包体积；其他期刊没有提供音频的文章保持原状，原有本地音频保留。
